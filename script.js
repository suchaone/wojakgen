window.onload = function() {
  ...
  function generateTagline() {
    ...
    var WOMAN = [ 'girl', 'gal', 'lady', 'dame', 'princess', 'bitch', 'female', 'woman', 'femme', 'dyke', 'babe', 'broad' ];
    ...
    var forms = [ 
      ...
      [ 'reads NATIONALITY lit', 'XLY reads NATIONALITY lit', 'watches NATIONALITY films', 'listens to NATIONALITY MUSIC', 'recites NATIONALITY poetry to BODY PEOPLE', 'recites NATIONALITY poetry to ADJECTIVE HUMANS', 'recites NATIONALITY poetry to BODY HUMANS'],
    ...
    for (var i = 0 ; i < 10; i++) {
      ...
      form = form.replace('MUSIC', pickRandom(GENRE));
