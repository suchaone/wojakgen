window.onload = function() {
  ...
  function generateTagline(forms) {
    ...
    var DATESITE    = [ 'okcupid', 'tinder', 'pof', 'eharmony', 'lavalife', 'jdate', 'match dot com', 'badoo', 'fetlife', 'hinge' ];
    ...
    var TATLOC      = [ 'haunch', 'chest', 'back', 'shoulder', 'thigh', 'ass', 'bicep' ];
    ...
    var ATTAINABLE  = [ 'arete', 'gnosis', 'enlightenment', 'spiritual enlightenment', 'nirvana', 'samadhi', 'moksha', 'liberation', 'salvation', 'henosis', 'unity', 'theosis', 'happiness', 'fulfillment', 'self-actualization', 'ego death', 'self-knowledge', 'buddhahood', 'catharsis' ];
