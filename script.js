window.onload = function() {
  ...
  var ADJECTIVE         = [ 'deranged', 'deluded', 'uncanny', 'wayward', 'fiery', 'big', 'tiny', 'violent', 'lying', 'omnipresent', 'omniscient', 'fearful', 'brave', 'friendly', 'playful', 'greasy', 'rabid' ];
  ...
  function generateTagline() {
    ...
    var BOOZE       = [ 'vodka', 'scotch', 'whiskey', 'bourbon', 'gin', 'wine', 'red wine', 'white whine', 'merlot', 'cabernet sauvignon', 'pinot noir', 'sauvignon blanc', 'chardonnay', 'cognac', 'brandy', 'liqueur', 'rye whiskey', 'vermouth', 'absinthe', 'beer', 'cider', 'rice wine', 'soju', 'sake', 'tequila', 'arak' ];
    var DRINK       = [ 'coffee', 'tea', 'black tea', 'oolong tea', 'green tea', 'bubble tea', 'jasmine tea', 'pu erh tea', 'hibiscus tea', 'chamomile tea', 'pepsi', 'sprite', 'root beer', 'soda', 'club soda', 'FRUIT juice', 'FRUIT cocktails', 'BOOZE', 'matcha', 'yerba mate', 'hot chocolate', 'red bull', 'kefir', 'milk', 'soy milk', 'almond milk', 'rice milk', 'yak milk', 'goat milk', 'red wine', 'white wine', 'rice wine', 'jim beam', 'moonshine', 'jagermeister', 'goldschlager', 'beer', 'heineken', 'bud light', 'guinness', 'ale', 'ginger ale', 'dr pepper', 'soda', 'BEAST blood', 'FRUIT wine', 'FRUIT liqueur' ];
    ...
    var BODY        = [ 'skinny', 'chubby', 'fat', 'obese', 'overweight', 'fit', 'muscular', 'thick', 'thicc', 'athletic', 'skinny', 'statuesque', 'tall', 'short', 'curvy', 'voluptuous', 'attractive', 'ugly', 'sexy', 'hideous', 'beautiful', 'sensual', 'hot', 'beefy', 'muscular', 'grotesque', 'flabby', 'chiseled', 'cuddly', 'round', 'gaunt', 'lean' ];
    ...
    var FEEL        = [ 'shame', 'guilt', 'ennui', 'alienation', 'fear', 'arousal', 'hate', 'love', 'fear', 'horror', 'existential horror', 'dread', 'anger', 'sadness', 'sorrow', 'melancholia', 'disgust', 'surprise', 'trust', 'envy', 'gnosis' ];
    ...
    var BUSINESS    = [ 'convenience store', 'bodega', 'video game store', 'deli', 'MEAT cart', 'bakery', 'auto repair shop', 'used car lot', 'newspaper stand', 'mcdonalds franchise', 'strip club', 'DRUG dispensary', 'BEAST farm', 'FRUIT farm', 'PHENOMENON research center', 'brothel', 'makeup counter', 'startup', 'organic farm', 'antique shop', 'bookstore', 'DRINK bar', nationality + ' buffet', nationality + ' restaurant', '3d scanning service', 'call center', '3d printing service' ];
    ...
    var forms = [ 
      ...
      [ 'cooks BEASTs for PEOPLE', 'cooks BEASTs for NATIONALITY PEOPLE', 'has a BODY BEAST fursona', 'experiments on BEASTs', 'administers DRUG to BEASTs', 'his ADJECTIVE pet BEAST is his only friend', 'more BEAST than ' + ( gender === 'male' ? 'man' : 'woman' ), 'looks like a ADJECTIVE BEAST', 'looks like a BEAST', 'looks like a BODY BEAST', 'a BEAST in bed', 'a BEAST in the sack', 'acts like a BEAST in heat','walks like a BEAST', 'walks like a BODY BEAST', '"the ' + nationality + ' BEAST"', 'survived a BEAST attack', 'trained his pet BEAST to attack PEOPLE' ],
      [ 'XLY eats FOOD', 'loves TASTE FOOD', 'loves FOOD and DRINK', 'eats FOOD for MEALTIME', 'has FOOD and DRINK for MEALTIME', 'XLY guzzles FOOD', 'drinks DRINK', 'sips DRINK', 'drinks nothing but DRINK', 'drinks nothing but TEMPERATURE DRINK', 'XLY drinks DRINK', 'XLY sips DRINK', 'drinks DRINK from a MATERIAL VESSEL', 'sips DRINK from a MATERIAL VESSEL', 'eats FOOD with PEOPLE', 'feeds FOOD to PEOPLE', 'feeds MEAT to BEASTs', 'feeds MEAT to his pet BEAST', 'cooks FOOD for PEOPLE', 'only eats ' + nationality + ' food' ],
      [ 'reads NATIONALITY lit', 'XLY reads NATIONALITY lit', 'watches NATIONALITY FILM', 'watches FILM with PEOPLE', 'watches SHOW with PEOPLE', 'watches NATIONALITY FILM with PEOPLE','listens to NATIONALITY MUSIC', 'recites ' + (nationality === 'american' ? 'NATIONALITY' : nationality) + ' poetry to BODY PEOPLE', 'recites NATIONALITY poetry to ADJECTIVE HUMANS', 'recites NATIONALITY poetry to BODY HUMANS'],
      ...
      [ 'XLY wears FABRIC', 'XLY wears FABRIC SHIRTs', 'wears FABRIC', 'wears FABRIC SHIRTs' ],
      [ 'a PROF OCCUPATION', 'LEVEL SKILL' ],
      [ 'FAMED for his PROPERTY', 'FAMED for his ADJECTIVE PROPERTY', 'FAMED for his ACCENT ' + nationality + ' accent', 'has the PROPERTY of a BEAST', 'has the PROPERTY of a BOSS', 'guilty of VICE', 'thinks that VICE is a sin', 'arrested for VICE', 'beaten for VICE', 'rebuked for VICE', 'shamed for VICE', 'shunned for VICE', 'imprisoned for VICE', 'guilty of PROPERTY', 'FAMED for his BODY body', 'FAMED for his BODY figure', 'FAMED for his DEGREE', 'FAMED for his FEEL', 'wants to be FAMED', 'wants to be FAMED by PEOPLE' ],
      [ 'WORK PLACE', 'runs a BUSINESS', 'manages a BUSINESS', 'owns a BUSINESS', 'works at a BUSINESS', 'runs a BUSADJ BUSINESS', 'manages a BUSADJ BUSINESS', 'owns a BUSADJ BUSINESS', 'works at a BUSADJ BUSINESS'],
      [ 'FREQ EXPER FEEL', 'LOOKING someone to DOWITH', 'wants to DOWITH CELEBRITY', 'LOOKING a PERSON to DOWITH', 'LOOKING a WOMAN to DOWITH', 'LOOKING a ADJECTIVE PERSON to DOWITH', 'LOOKING a ADJECTIVE WOMAN to DOWITH', 'makes PEOPLE feel FEEL', 'FREQ EXPER FEEL around PEOPLE', 'FREQ EXPER FEEL PLACE'],
