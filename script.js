window.onload = function() {
  ...
  function generateTagline() {
    ...
    var BUSINESS    = [ 'convenience store', 'bodega', 'video game store', 'deli', 'MEAT cart', 'bakery', 'auto repair shop', 'used car lot', 'newspaper stand', 'FRANCHISE franchise', 'FRANCHISE', 'strip club', 'DRUG dispensary', 'BEAST farm', 'FRUIT farm', 'PHENOMENON research center', 'brothel', 'makeup counter', 'startup', 'organic farm', 'antique shop', 'bookstore', 'DRINK bar', nationality + ' buffet', nationality + ' restaurant', '3d scanning service', 'call center', '3d printing service' ];
    ...
    var forms = [ 
      ...
      [ 'ADVERB wears FABRIC', 'ADVERB wears FABRIC SHIRTs', 'wears FABRIC', 'wears FABRIC SHIRTs', 'dresses like a FEMJOB', 'wears the latest ' + nationality + ' fashion' ],
