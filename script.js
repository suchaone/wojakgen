window.onload = function() {
  ...
  function generateTagline() {
    ...
    var PHENOMENON = ['lightning', 'clouds', 'the aurora borealis', 'gravity', 'electromagnetism', 'society', 'culture', 'death', 'life', 'birth', 'conception', 'contraception', 'disease', 'change', 'stasis', 'continental drift', 'evolution', 'rotation', 'motion', 'light', 'darkness', 'heat', 'temperature', 'frost', 'snow', 'ice', 'tension', 'friction', 'growth', 'cognition' ];
    ...
    var LEVEL  = [ 'knows nothing about', 'knows about', 'knows a thing or two about', 'familiar with', 'tried his hand at', 'sucks at', 'adequate at', 'competent at', 'good at', 'expert at', 'master of', 'grandmaster of' ];
    ...
    var LOOKING = [ 'looking for', 'seeking', 'searching for', 'on the hunt for', 'on the search for', 'won\'t rest until he finds', 'hopes to find', 'dreams to find', 'wishes to find' ];
    var SHOW    = [ 'south park', 'bojack horseman', 'rick and morty', 'sailor moon' ];
