window.onload = function() {
  ...
  function generateTagline() {
    ...
    var BELIEF      = [ 'PEOPLE are ADJECTIVE', 'all PEOPLE are ADJECTIVE', 'not all PEOPLE are ADJECTIVE', 'PEOPLE are to blame for PHENOMENON', 'PHENOMENON is caused by PEOPLE', 'FEEL is caused by PEOPLE', 'PHENOMENON is a social construct', 'PHENOMENON is a spook', 'PHENOMENON is degenerate', 'FEEL is degenerate', 'PEOPLE are degenerates', 'SKILL is degenerate', 'PEOPLE are underrepresented in the INDUSTRY industry', 'PEOPLE are overrepresented in the INDUSTRY industry' ];
