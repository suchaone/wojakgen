window.onload = function() {
  ...
  function generateTagline(forms) {
    ...
    var WOMAN       = [ 'egirl', 'girl', 'gal', 'lady', 'lass', 'dame', 'princess', 'bitch', 'female', 'woman', 'femme', 'dyke', 'babe', 'broad', 'chick', 'harlot', 'soul', 'individual', 'harpy', 'creature', 'qt', Math.round(randomBetween(6,10)) + '/10 qt'  ];
    ...
    var FAN         = [ 'fan', 'fanboy', 'worshipper', 'admirer', 'acolyte', 'simp' ];
    ...
    var GAME        = [ 'pokemon', 'super mario', 'mortal kombat', 'zelda', 'sim city', 'minecraft', 'civ3', 'dota', 'league', 'starcraft', 'diablo', 'ddr', 'quake', 'tic-tac-toe', 'd&d', 'undertale', 'portal', 'overwatch', 'warcraft', 'everquest', 'street fighter', 'contra', 'donkey kong', 'pong', 'halo', 'counter-strike', 'red alert', 'joust', 'dota', 'basketball', 'football', 'baseball', 'pinball', 'hockey', 'badminton', 'tennis', 'squash', 'bowling', 'bocce', 'petanque', 'volleyball', 'foozeball', 'ball', 'golf', 'polo', 'water polo', 'calvinball', 'beer pong', 'poker', 'durak', 'go fish', 'go', 'chess', 'checkers', 'monopoly', 'cards against humanity', 'mahjong', 'tekken', 'metal slug', 'tekken', 'farmville', 'candy crush', 'last of us', 'crusader kings', 'europa universalis', 'among us' ];
    ...
    var HUMANS      = [ 'boomers', 'doomers', 'zoomers', 'coomers', 'women', 'girls', 'ladies', 'females', 'dames', 'chicks', 'babes', 'men', 'dudes', 'boys', 'lads', 'guys', 'hotties', 'bimbos', 'sluts', 'cholas', 'gals'];
    ...
    var DATESITE    = [ 'okcupid', 'tinder', 'pof', 'eharmony', 'lavalife', 'jdate', 'match dot com', 'badoo', 'fetlife', 'hinge', 'bumble', 'grindr' ];
    ...
    var TATLOC      = [ 'haunch', 'chest', 'back', 'shoulder', 'thigh', 'ass', 'buttcheek', 'bicep', 'calf' ];
    ...
    var SKILL       = [ 'miniature painting', 'dry-felting', 'crochet', 'cooking', 'baking', 'painting', 'programming', 'writing', 'weaving', 'singing', 'playing the INSTRUMENT', 'GAME', 'drawing', 'shitposting', 'blogging', 'tweeting', 'sewing', 'talking to PEOPLE', 'dancing', 'hacking', 'bodybuilding', 'ux design', 'trolling', 'game design', 'photoshop', 'illustrator', 'working out', 'BEAST taming', 'BEAST tending', 'BEAST breeding', 'soldering', 'welding', 'plumbing', 'crochet', 'driving', 'gambling', 'fishing', 'whaling', 'BEAST hunting' ];
    ...
    var BUSADJ      = [ 'notorious', 'profitable', 'unprofitable', 'vc funded', 'successful', 'popular', 'famous', 'infamous', 'sketchy', 'illegal', 'trendy' ];
    ...
    var MEALTIME    = [ 'breakfast', 'brunch', 'lunch', 'dinner', 'supper', 'second breakfast', 'elevenses', 'snacktime' ];
    ...
    var ATTAINABLE  = [ 'kundalini awakening', 'arete', 'gnosis', 'enlightenment', 'spiritual enlightenment', 'nirvana', 'samadhi', 'moksha', 'liberation', 'salvation', 'henosis', 'unity', 'theosis', 'happiness', 'fulfillment', 'self-actualization', 'ego death', 'self-knowledge', 'buddhahood', 'catharsis' ];
