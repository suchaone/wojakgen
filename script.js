window.onload = function() {
  ...
  function generateTagline() {
    ...
    var forms = [ 
      ...
      [ 'a PROF OCCUPATION', 'LEVEL SKILL', 'lies about being a OCCUPATION', 'brags about being a OCCUPATION' ],
      [ 'FAMED for his PROPERTY', 'FAMED for his ADJECTIVE PROPERTY', 'FAMED for his ACCENT ' + nationality + ' accent', 'has the PROPERTY of a BEAST', 'has the PROPERTY of a BOSS', 'guilty of VICE', 'thinks that VICE is a sin', 'arrested for VICE', 'beaten for VICE', 'rebuked for VICE', 'shamed for VICE', 'shunned for VICE', 'imprisoned for VICE', 'guilty of PROPERTY', 'FAMED for his BODY body', 'FAMED for his BODY figure', 'FAMED for his DEGREE', 'FAMED for his FEEL', 'wants to be FAMED', 'wants to be FAMED by PEOPLE', 'kicked out of his home for VICE', 'deported for VICE' ],
      ...
      [ 'FREQ EXPER FEEL', 'LOOKING someone to DOWITH', 'wants to DOWITH CELEBRITY', 'LOOKING a PERSON to DOWITH', 'LOOKING a WOMAN to DOWITH', 'LOOKING a ADJECTIVE PERSON to DOWITH', 'LOOKING a ADJECTIVE WOMAN to DOWITH', 'makes PEOPLE feel FEEL', 'forces PEOPLE to feel FEEL','FREQ EXPER FEEL around PEOPLE', 'FREQ EXPER FEEL PLACE'],
