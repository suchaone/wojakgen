window.onload = function() {
  ...
  function generateTagline() {
    ...
    var BODY = [ 'skinny', 'chubby', 'fat', 'obese', 'overweight', 'fit', 'muscular', 'thick', 'thicc', 'athletic', 'skinny', 'statuesque', 'tall', 'short', 'curvy', 'voluptuous', 'attractive', 'ugly', 'sexy', 'hideous', 'beautiful', 'sensual', 'hot', 'beefy', 'muscular' ];
    ...
    var PHENOMENON = ['lightning', 'clouds', 'aurora borealis', 'gravity', 'electromagnetism', 'society', 'culture', 'death', 'life', 'birth', 'conception', 'contraception', 'disease', 'change', 'stasis', 'continental drift', 'evolution', 'rotation', 'motion', 'light', 'darkness', 'heat', 'temperature', 'frost', 'snow', 'ice', 'tension', 'friction', 'growth', 'cognition' ];
    ...
    var FILM   = [ 'horror films', 'comedies', 'romantic comedies', 'telenovelas', 'cartoons', 'anime', 'snuff films', 'art films', 'dramas', 'action movies', 'sitcoms' ];
    ...
    var LOOKING = [ 'looking for', 'seeking', 'searching for', 'on the hunt for', 'on the search for', 'won\'t rest until he finds', 'hopes to find', 'dreams to find', 'wishes to find', 'aims to find', 'posted a craigslist ad seeking' ];
    ...
    var forms = [ 
      ...
      [ 'cooks BEASTs for PEOPLE', 'cooks BEASTs for NATIONALITY PEOPLE', 'has a BODY BEAST fursona', 'experiments on BEASTs', 'administers DRUG to BEASTs', 'his ADJECTIVE pet BEAST is his only friend', 'more BEAST than ' + ( gender === 'male' ? 'man' : 'woman' ), 'looks like a ADJECTIVE BEAST', 'looks like a BEAST', 'looks like a BODY BEAST', 'a BEAST in bed', 'a BEAST in the sack', 'acts like a BEAST in heat','walks like a BEAST', 'walks like a BODY BEAST', '"the ' + nationality + ' BEAST"', 'survived a BEAST attack', 'a BEAST in a past life' ],
      ...
      [ 'meets HUMANS on DATESITE', 'meets BODY HUMANS on DATESITE', 'meets NATIONALITY HUMANS on DATESITE', 'meets BODY NATIONALITY HUMANS on DATESITE', 'treats DATESITE dates to FOOD', 'watches FILM with his DATESITE dates', 'watches NATIONALITY FILM with his DATESITE dates', 'meets RELIGION HUMANS on DATESITE', 'plays GAME with his DATESITE dates' ],
      ...
      [ 'FAMED for his PROPERTY', 'FAMED for his ADJECTIVE PROPERTY', 'FAMED for his ACCENT ' + nationality + ' accent', 'has the PROPERTY of a BEAST', 'has the PROPERTY of a BOSS', 'guilty of VICE', 'arrested for VICE', 'guilty of PROPERTY', 'FAMED for his BODY body', 'FAMED for his BODY figure', 'FAMED for his DEGREE', 'FAMED for his FEEL' ],
      [ 'WORK PLACE' ],
      [ 'FREQ EXPER FEEL', 'FREQ EXPER his FEEL', 'LOOKING someone to DOWITH',  'LOOKING a PERSON to DOWITH', 'LOOKING a WOMAN to DOWITH', 'LOOKING a ADJECTIVE PERSON to DOWITH', 'LOOKING a ADJECTIVE WOMAN to DOWITH','makes PEOPLE feel FEEL', 'FREQ EXPER FEEL around PEOPLE', 'FREQ EXPER FEEL PLACE'],
